...
DROP TABLE IF EXISTS #__os_cck_suggestion,#__os_cck_review,#__os_cck_rent_request,#__os_cck_buying_request;

ALTER TABLE #__os_cck_files_child_parent_connect RENAME #__os_cck_child_parent_connect;

ALTER TABLE `#__os_cck_child_parent_connect` ADD `media_type` varchar(255) NOT NULL;
ALTER TABLE `#__os_cck_layout` ADD `custom_fields`  MEDIUMBLOB NOT NULL;
ALTER TABLE `#__os_cck_layout` ADD `mail` MEDIUMBLOB NOT NULL;
ALTER TABLE `#__os_cck_layout` ADD `alias` varchar(255) NOT NULL,
--
...
ALTER TABLE `#__os_cck_entity_instance` 
...
INSERT IGNORE INTO `#__os_cck_mime_types` VALUES 

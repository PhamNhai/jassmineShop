--
-- Table structure for table `#__os_cck_version`
--
...
CREATE TABLE IF NOT EXISTS #__os_cck_layout_html (
...
--
-- Table structure for table `#__os_cck_access`
--

CREATE TABLE IF NOT EXISTS `#__os_cck_access` (
...
--
-- Table structure for table `#__os_cck_categories`
--

CREATE TABLE IF NOT EXISTS `#__os_cck_categories` (
...
--
-- Table structure for table `#__os_cck_categories_connect`
--

CREATE TABLE IF NOT EXISTS `#__os_cck_categories_connect` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__os_cck_entity`
--

CREATE TABLE IF NOT EXISTS `#__os_cck_entity` (
  ...
  `created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'The Unix timestamp when the entity was created.',
  `changed` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'The Unix timestamp when the entity was most recently saved.',
  `checked_out` int(11) NOT NULL DEFAULT '0' COMMENT 'If some user edit this record. There are that userID .',
  `checked_out_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Time when checkout started .',
  PRIMARY KEY (`eid`),
...
--
-- Table structure for table `#__os_cck_entity_field`
--

CREATE TABLE IF NOT EXISTS `#__os_cck_entity_field` (
...
--
-- Table structure for table `#__os_cck_entity_instance`
--

CREATE TABLE IF NOT EXISTS `#__os_cck_entity_instance` (
  ...
  KEY `entity_created` (`created`),
  KEY `teid` (`teid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='The table for instanses entitys.' AUTO_INCREMENT=6 ;

--
-- Table structure for table `#__os_cck_files`
--

CREATE TABLE IF NOT EXISTS `#__os_cck_files` (
...
--
-- Table structure for table `#__os_cck_child_parent_connect`
--

CREATE TABLE IF NOT EXISTS `#__os_cck_child_parent_connect` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__os_cck_layout`
--

CREATE TABLE IF NOT EXISTS `#__os_cck_layout` (
...
--
-- Table structure for table `#__os_cck_rent`
--

CREATE TABLE IF NOT EXISTS `#__os_cck_rent` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `fk_eiid` int(11) NOT NULL DEFAULT '0' COMMENT 'The eiid from table __os_cck_entity_instance.',
...
CREATE TABLE IF NOT EXISTS #__os_cck_video_source (
  `id` int(11) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS #__os_cck_track_source (
  `id` int(11) unsigned NOT NULL auto_increment,
  `fk_eiid`int(11) DEFAULT NULL,
  `sequence_number` int(11) DEFAULT NULL,
  `src` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS #__os_cck_audio_source (
  `id` int(11) unsigned NOT NULL auto_increment,
  `fk_eiid` int(11) DEFAULT NULL,
  `sequence_number` int(11) DEFAULT NULL,
  `src` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__os_cck_mime_types`;

CREATE TABLE IF NOT EXISTS `#__os_cck_mime_types` (
...
INSERT INTO `#__os_cck_mime_types` VALUES

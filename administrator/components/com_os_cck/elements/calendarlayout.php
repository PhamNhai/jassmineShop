...
class JFormFieldCalendarlayout extends JFormField{
  protected function getInput(){
    ...
    $link = JRoute::_('index.php?option=com_os_cck&task=manage_layout_modal&layout_type=calendar&tmpl=component');
    $rel="{handler: 'iframe', size: {x: 900, y: 550}}";
    $lid = (isset($params->calendar_layout) 
            && !empty($params->calendar_layout))? $params->calendar_layout : '';

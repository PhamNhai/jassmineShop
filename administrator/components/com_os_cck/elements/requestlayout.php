...
class JFormFieldRequestlayout extends JFormField{
  protected function getInput(){
    ...
    $link = JRoute::_('index.php?option=com_os_cck&task=manage_layout_modal&layout_type=request_instance&tmpl=component');
    $rel="{handler: 'iframe', size: {x: 900, y: 550}}";
    $lid = (isset($params->request_layout) 
            && !empty($params->request_layout))? $params->request_layout : '';

...
class JFormFieldSearchlayout extends JFormField{
  protected function getInput(){
    ...
    $link = JRoute::_('index.php?option=com_os_cck&task=manage_layout_modal&layout_type=search&tmpl=component');
    $rel="{handler: 'iframe', size: {x: 900, y: 550}}";
    $lid = (isset($params->search_layout) 
            && !empty($params->search_layout))? $params->search_layout : '';

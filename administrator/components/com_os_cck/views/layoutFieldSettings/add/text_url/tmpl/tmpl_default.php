...
$field_default = (isset($lParams[$fName.'_default'])) ? $lParams[$fName.'_default'] : 'http://';
...
<div id="options-field-<?php echo $fName?>">
    ...
    <div>
        ...
        <input type="text" size="4" name="fi_<?php echo $fName?>_default"  value="<?php echo $field_default?>" >
    </div>

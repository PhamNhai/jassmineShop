...
$field_editor_field = (isset($lParams[$fName.'_editor_field'])) ? $lParams[$fName.'_editor_field'] : 0;
...
<div id="options-field-<?php echo $fName?>">
    ...
    <div>
        <label><?php echo JText::_("COM_OS_CCK_LABEL_ENABLE_EDITOR")?></label>
        <input type="radio" name="fi_<?php echo $fName?>_editor_field"  <?php echo $field_editor_field?'checked':''?> value="1">Yes
        <input type="radio" name="fi_<?php echo $fName?>_editor_field"  <?php echo $field_editor_field?'':'checked'?> value="0">No
    </div>

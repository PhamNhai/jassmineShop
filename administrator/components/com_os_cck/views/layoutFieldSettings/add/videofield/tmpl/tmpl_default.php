...
$field_add_track = (isset($lParams[$fName.'_add_track'])) ? $lParams[$fName.'_add_track'] : 0;
...
<div id="options-field-<?php echo $fName?>">
    ...
    <div>
        <label><?php echo JText::_("COM_OS_CCK_LABEL_ADD_TRACK")?></label>
        <input type="radio" name="fi_<?php echo $fName?>_add_track"  <?php echo $field_add_track?'checked':''?> value="1">Yes
        <input type="radio" name="fi_<?php echo $fName?>_add_track"  <?php echo $field_add_track?'':'checked'?> value="0">No
    </div>

...
$field_output_format = (isset($lParams[$fName.'_output_format'])) ? $lParams[$fName.'_output_format'] : 'Y-m-d';
...
<div id="options-field-<?php echo $fName?>">
    ...
    <div>
        <label><?php echo JText::_("COM_OS_CCK_LABEL_SHOW_OUTPUT_FORMAT")?> <i title="<?php echo JText::_("COM_OS_CCK_DATE_FIELD_TOOLTIP")?>" class="glyphicon glyphicon-info-sign date_tooltip"></i></label>

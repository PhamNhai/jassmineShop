...
$link_text = (isset($lParams[$fName.'_link_text'])) ? $lParams[$fName.'_link_text'] : 'Download';
...
<div id="options-field-<?php echo $fName?>">
    ...
    <div>
        <label><?php echo JText::_("COM_OS_CCK_LABEL_LINK_TEXT")?></label>
        <input type="text" size="4" name="fi_<?php echo $fName?>link_text"  value="<?php echo $link_text?>" >
    </div>
    <div>

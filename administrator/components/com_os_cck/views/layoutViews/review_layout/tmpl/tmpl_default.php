...
<!-- layout notice -->
  <?php 
    noticeLinkToDocLayout('review_instance', 'Add Review Layout', 'http://ordasoft.com/News/OS-CCK-Documentation/cck-term-explanation.html#Show / Add Review Layout');
  ?>
<!-- /layout notice -->
          ...
          <div id="form-options-accordion">
            ...
            <div class="main-fields-content">
              ...
              <div class="category-options">
                ...
                <label><?php echo JText::_('COM_OS_CCK_LAYOUT_APPROVE'); ?></label> <i title="<?php echo JText::_("COM_OS_CCK_LAYOUT_APPROVE_TOOLTIP")?>" class="glyphicon glyphicon-info-sign date_tooltip"></i>
                <input type="checkbox" <?php echo isset($layout_params["views"]["layout_approve_on_add"])?' checked="checked" ':''?> name="vi_layout_approve_on_add">
              ...
              <div class="category-options">
                <label><?php echo JText::_('COM_OS_CCK_LAYOUT_PUBLISH_ON_ADD'); ?></label> <i title="<?php echo JText::_("COM_OS_CCK_LAYOUT_PUBLISH_ON_ADD_TOOLTIP")?>" class="glyphicon glyphicon-info-sign date_tooltip"></i>

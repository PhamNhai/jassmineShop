...
<!-- layout notice -->
  <?php 
    noticeLinkToDocLayout('rent_request', 'Rent Request Layout', 'http://ordasoft.com/News/OS-CCK-Documentation/cck-term-explanation.html#Add Rent Request Form');
  ?>
<!-- /layout notice -->
          ...
          <div id="form-options-accordion">
           ...
           <h3><?php echo JText::_("COM_OS_CCK_STYLING_LABEL_ACCORDION_FIELDS_MAIN_OPTIONS") ?></h3>
            <div class="main-fields-content">
              ...
              <div class="category-options">
                <label><?php echo JText::_('COM_OS_CCK_LAYOUT_PRICE_PER_PERIOD'); ?>
                    <i title="<?php echo JText::_("COM_OS_CCK_LAYOUT_PRICE_PER_PERIOD_TOOLTIP")?>" class="glyphicon glyphicon-info-sign date_tooltip"></i>
                </label>
                <?php  print_r($layout->price_per_period);?>
              </div>
  ...
  function make_droppable(){
    jQuerCCK(".drop-area").droppable({
      ...
      drop: function( event, ui ) {
        ...
        draggable.find("div").append(delete_button);

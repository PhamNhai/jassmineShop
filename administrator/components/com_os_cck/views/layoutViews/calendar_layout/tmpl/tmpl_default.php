...
$calendar_table = new stdClass();
$calendar_table->label = JText::_("COM_OS_CCK_CALENDAR_TABLE_FIELD");
$calendar_table->db_field_name = 'calendar_table';
$calendar_table->description = 'Calendar';

$calendar_month_year = new stdClass();
$calendar_month_year->label = JText::_("COM_OS_CCK_MONTH_YEAR_FIELD");
$calendar_month_year->db_field_name = 'calendar_month_year';
$calendar_month_year->description = 'Month - year selector';

$calendar_pagination = new stdClass();
$calendar_pagination->label = JText::_("COM_OS_CCK_CALENDAR_NAVIGATION_FIELD");
$calendar_pagination->db_field_name = 'calendar_pagination';
$calendar_pagination->description = 'Pagination block for this layout';


$unique_fields = array($calendar_table, 
                       $calendar_month_year, 
                       $calendar_pagination);
//end
...
<!-- layout notice -->
<?php 
  noticeLinkToDocLayout('calendar_layout', 'Calendar', 'http://ordasoft.com/News/OS-CCK-Documentation/cck-term-explanation.html#Show Calendar');
?>
<!-- /layout notice -->
        ...
        <div id="options-tab-1">
          <div id="fields-options-accordion">
            ...
            <div class="main-fields-content">
              ...
              foreach ($unique_fields as $field) {
                require getLayoutPathCCK::getAdminLayoutViewPath('com_os_cck', 'calendar_layout', 'fieldUniq');
              }

              if(isset($layout_params['views']['show_request_layout'])){
                foreach ($layout_params['views']['show_request_layout'] as $key => $value) {
                  require getLayoutPathCCK::getAdminLayoutViewPath('com_os_cck', 'calendar_layout', 'layoutOptions');
                }
              }
              if(count($layout_params['unique_fields'])){
                foreach ($layout_params['unique_fields'] as $key => $custom_options){
                  require getLayoutPathCCK::getAdminLayoutViewPath('com_os_cck', 'calendar_layout', 'customField');
                }
              } ?>
            </div>
        ...
        <div id="options-tab-3">
          ...
          <h3><?php echo JText::_("COM_OS_CCK_STYLING_LABEL_ACCORDION_FIELDS_MAIN_OPTIONS") ?></h3>
            <div class="main-fields-content">
              ...
              <div class="category-options">
                <label><?php echo JText::_('COM_OS_CCK_LABEL_CURRENT_MONTH'); ?> <i title="<?php echo JText::_("COM_OS_CCK_LABEL_CURRENT_MONTH_TOOLTIP")?>" class="glyphicon glyphicon-info-sign date_tooltip"></i></label>
                <?php  echo $layout->month_calendar;?>
              </div>

              <!-- <div class="category-options">
                <label><?php echo JText::_('COM_OS_CCK_LAYOUT_EVENT_TITLE'); ?></label>
                <?php echo $layout->event_title; ?>
              </div> -->

              <div class="category-options">
                <label><?php echo JText::_('COM_OS_CCK_LAYOUT_SORT_BY'); ?></label>
                <?php echo $layout->event_sort_by; ?>
              </div>
              ...
              <div class="category-options">
                <label><?php echo JText::_('COM_OS_CCK_LAYOUT_EVENT_DATE'); ?> <i title="<?php echo JText::_("COM_OS_CCK_LAYOUT_EVENT_DATE_TOOLTIP")?>" class="glyphicon glyphicon-info-sign date_tooltip"></i></label>
                <?php echo $layout->event_date; ?>
              </div>
<!-- 
              <div class="category-options">
                <label><?php echo JText::_('COM_OS_CCK_LAYOUT_EVENT_DATE_FROM'); ?></label>
                <?php echo $layout->event_date_from; ?>
              </div>

              <div class="category-options">
                <label><?php echo JText::_('COM_OS_CCK_LAYOUT_EVENT_DATE_TO'); ?></label>
                <?php echo $layout->event_date_to; ?>
              </div> -->

              <div class="category-options">
                <label><?php echo JText::_('COM_OS_CCK_LAYOUT_SHOW_PAST_EVENTS'); ?></label>
                <?php echo $layout->show_past_events; ?>
              </div>

              <div class="category-options">
                <label><?php echo JText::_('COM_OS_CCK_SELECT_ALL_INSTANCE_CALENDAR'); ?> <i title="<?php echo JText::_("COM_OS_CCK_SELECT_ALL_INSTANCE_CALENDAR_TOOLTIP")?>" class="glyphicon glyphicon-info-sign date_tooltip"></i></label>
                <?php echo $layout->all_instanceLayout; ?>
              </div>

              <div class="category-options">
                <label><?php echo JText::_('COM_OS_CCK_SELECT_INSTANCE_CALENDAR'); ?> <i title="<?php echo JText::_("COM_OS_CCK_SELECT_INSTANCE_CALENDAR_TOOLTIP")?>" class="glyphicon glyphicon-info-sign date_tooltip"></i></label>
      ...
      drop: function( event, ui ) {
        ...
        if(draggable.find(".field-name").length
          ...
          //end
            ...
            && (draggable.find(".field-name").data("field-name") == "calendar_pagination"
                        || draggable.find(".field-name").data("field-name") == "calendar_month_year")){
           //field block
          del_field();
          hide_options();
          makeOptions();

...
<!-- layout notice -->
  <?php 
    noticeLinkToDocLayout('buy_request_layout', 'Buy request layout', 'http://ordasoft.com/News/OS-CCK-Documentation/cck-term-explanation.html#Add Buy Request Form');
  ?>
<!-- /layout notice -->

...
class AdminViewBuy_request{
  ...
  static function editBuyRequestInstance($option, & $entityInstance, & $str_list){
    global $os_cck_configuration,$user, $app, $session;
    $html = "<div class='os_cck_caption' ><img src='./components/com_os_cck/images/os_cck_logo.png' alt ='Config' />" . JText::_('COM_OS_CCK_ADMIN_LABLE_ORDER') . "</div>";
    $app = JFactory::getApplication();
    $app->JComponentTitle = $html;
    ...
    $doc->addScript('http://maps.google.com/maps/api/js?'.$key);

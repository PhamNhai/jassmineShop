...
<?php
	...
	<textarea style="height: <?php echo $formSettings[3]; ?>; font-size: <?php echo $formSettings[4] ?>;
		color: <?php echo $formSettings[5]; ?>; background-color: <?php echo $formSettings[6]; ?>;
		<?php echo $formSettings[7]; ?>; border-radius: <?php echo $formSettings[8]; ?>; min-height: <?php echo $options[4]; ?>px;"

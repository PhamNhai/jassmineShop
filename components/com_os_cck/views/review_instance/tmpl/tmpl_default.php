...
<div class="cck-body">
  ...
  if($show_type == 3){
    ...
    <a <?php echo $button_style['field_styling'];?>  class="button <?php echo $button_style['custom_class'];?>" href="<?php echo $link ?>">
      <?php echo ($layout_params['button_name'])?$layout_params['button_name'] : JText::_('COM_OS_CCK_BUTTON_SHOW_FORM_REVIEW_REQUEST'); ?>
    </a>
    <?php
    echo "</div>"; //close <div class="cck-body">
    return;
  ...
  if($show_type == 2){?>
    <input <?php echo $button_style['field_styling'];?>  type="button" class="button btn btn-info <?php echo $button_style['custom_class'];?>" value="<?php echo ($layout_params['button_name'])?$layout_params['button_name'] : JText::_('COM_OS_CCK_BUTTON_SHOW_FORM_REVIEW_REQUEST'); ?>"
  ...
  <form class="<?php echo $form_custom_class; ?>" <?php echo $form_styling; ?> action="index.php" method="post" name="<?php echo $unique_form_id?>" id="<?php echo $unique_form_id?>" enctype="multipart/form-data">
    ...
    ob_start();
      ...
      $buttonText = isset($layout_params["views"]["layout_button_text"])
                    && !empty($layout_params["views"]["layout_button_text"])?$layout_params["views"]["layout_button_text"]:JText::_('COM_OS_CCK_BUTTON_FORM_REVIEW_REQUEST');
      ?>
      <input <?php echo $field_styling; ?> type="button" name="review_button" value="<?php echo $buttonText; ?>"
                      class="button <?php echo $custom_class; ?>" onclick="javascript:sendRequest<?php echo $layout->type?>('send_review_request',<?php echo $unique_form_id?>);">
      <?php

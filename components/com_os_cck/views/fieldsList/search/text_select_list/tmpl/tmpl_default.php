...
// if(!$allowed_values)
$arr[] = JHTML::_('select.option', 0, JText::_('COM_OS_CCK_PLEASE_SELECT_OPTION'), "value", "text");
...
$value = $jinput->get("os_cck_search_".$field->db_field_name, '');
...
echo JHTML::_('select.genericlist', $arr, $tag_name, $field_styling.' class="'.$custom_class.$required.'"'.$select_type, $key, $text, $value);

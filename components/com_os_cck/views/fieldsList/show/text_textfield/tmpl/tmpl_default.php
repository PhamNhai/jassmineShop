...
<span 
rel="tooltip" data-toggle="tooltip" data-placement="top" title="<?php echo (isset($layout_params['fields'][$fName.'_tooltip']) && isset($layout_params['fields']['description_'.$fName]) && $layout_params['fields']['description_'.$fName]=='on')?$layout_params['fields'][$fName.'_tooltip']:'';?>"

...
<div class="cck-body">
  ...
  if($show_type == 3){
    ...
    <a <?php echo $button_style['field_styling'];?> class="button <?php echo $button_style['custom_class'];?>" href="<?php echo $link ?>">
      <?php echo ($layout_params['button_name'])?$layout_params['button_name'] : JText::_('COM_OS_CCK_BUTTON_SHOW_FORM_SEND_REQUEST'); ?>
    </a>
    <?php
    echo "</div>"; //close <div class="cck-body">
    return;
  ...
  if($show_type == 2){?>
    <input <?php echo $button_style['field_styling'];?> type="button" class="button btn btn-info <?php echo $button_style['custom_class'];?>" value="<?php echo ($layout_params['button_name'])?$layout_params['button_name'] : JText::_('COM_OS_CCK_BUTTON_SHOW_FORM_SEND_REQUEST'); ?>"
  ...
  <form class="<?php echo $form_custom_class; ?>" <?php echo $form_styling; ?> action="index.php" method="post" name="<?php echo $unique_form_id?>" id="<?php echo $unique_form_id?>" enctype="multipart/form-data">
    ...
    ob_start();
      ...
      <input <?php echo $field_styling; ?> type="button" name="request_button" value="<?php echo $buttonText; ?>"
                   class="button <?php echo $custom_class; ?>" onclick="javascript:sendRequest<?php echo $layout->type?>('send_request',<?php echo $unique_form_id?>);">
    <?php
    ...
    function sendRequest<?php echo $layout->type?> (task,form_name){
      ...
      if(form.new_upload_track_url1){
        ...
        jQuerCCK(required_fields).each(function(index, el) {
         ...
         if(jQuerCCK("input[name*='fi_decimal_textfield_']").length){
          jQuerCCK("input[name*='fi_decimal_textfield_']").each(function(index, el) {

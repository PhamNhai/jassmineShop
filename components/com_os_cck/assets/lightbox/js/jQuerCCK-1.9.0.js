/*! jQuerCCK v1.9.0 | (c) 2005, 2015 jQuerCCK Foundation, Inc. | jQuerCCK.org/license */
(function (e, t) {
  "use strict";
 ...
 J = e.jQuerCCK,
  ...
  st.fn = st.prototype = {
    ...
    init: function (e, n, r) {
      ...
      if (!e) return this;
      if ("string" == typeof e) {
        if (i = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : ft.exec(e), !i || !i[1] && n) return !n || n.jQuerCCK ? (n || r).find(e) : this.constructor(n).find(e);
        if (i[1]) {
    ...
    noConflict: function (t) {
	  return e.$ === st && (e.$ = G), t && e.jQuerCCK === st && (e.jQuerCCK = J), st
    },
    isReady: !1,
    readyWait: 1,
  ...
  st.extend({
    cache: {},
	expando: "jQuerCCK" + (Z + Math.random()).replace(/\D/g, ""),
    noData: {
      embed: !0,
  ...
  st.fn.extend({
    ...
    index: function (e) {
      return e ? "string" == typeof e ? st.inArray(this[0], st(e)) : st.inArray(e.jQuerCCK ? e[0] : e, this) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
    },
    add: function (e, t) {
 ...
 Xt = / jQuerCCK\d+="(?:null|\d+)"/g,
  ...
  st.fn.extend({
    ...
    if (n === t && (n = st.ajaxSettings && st.ajaxSettings.traditional), st.isArray(e) || e.jQuerCCK && !st.isPlainObject(e)) st.each(e, function () {
  ...
  jn = Pn.exec(Dn.toLowerCase()) || [], st.fn.load = function (e, n, r) {
    ...
    ajax: function (e, n) {
      ...
      var i, o, a, s, u, l, c, f, p = st.ajaxSetup({}, n),
        d = p.context || p,
        h = p.context && (d.nodeType || d.jQuerCCK) ? st(d) : st.event,
        g = st.Deferred(),
  ...
  }), e.jQuerCCK = e.$ = st, "function" == typeof define && define.amd && define.amd.jQuerCCK && define("jQuerCCK", [], function () {
    return st
  })
})(window);
//@ sourceMappingURL=jQuerCCK.min.map